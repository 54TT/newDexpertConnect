...
export  const getPrice = async (
    ...
    const poolContract = new ethers.Contract(poolAddress, uniswapV3PoolAbi, providers);
    ...
    const token0Contract = new ethers.Contract(token0Address, ERC20Abi, providers);
    const token1Contract = new ethers.Contract(token1Address, ERC20Abi, providers);
