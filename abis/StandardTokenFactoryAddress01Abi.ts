export const StandardTokenFactoryAddress01Abi = [
  {
    inputs: [
      { internalType: 'address', name: 'factoryManager_', type: 'address' },
      { internalType: 'address', name: 'implementation_', type: 'address' },
      { internalType: 'address', name: 'feeTo_', type: 'address' },
      { internalType: 'uint256', name: 'flatFee_', type: 'uint256' },
      { internalType: 'uint256', name: 'proxyFee_', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'factoryManager', type: 'address' },
    ],
