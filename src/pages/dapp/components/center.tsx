        ...
        <div className={'center'}>
            {
                <div className={'centerTop'}>
                    ...
                    <div className={'centerTopRight'} style={{paddingRight: browser ? '10%' : '2%'}}>
                        ...
                        <p>{router.pathname === '/app' && router.search ? 'Thor is a user-friendly DApp that automates the ERC-20 token creation process. By providing an intuitive interface and simplifying complex tasks, Thor empowers users to efficiently create and deploy their tokens.' : 'In the Uniswap protocol design, the development team does not extract fees from transactions, and all fees in transactions are returned to the liquidity provider.'}</p>
                        <div className={'dis'}>
                            {
