      ...
      <div className="wrapper">
        <div className="pay token-card">
          <div className="token-card-header dis-between">
            <span className="token-card-header-left">Pay</span>
            <span className="token-card-header-right">Balance:538.0012</span>
          </div>
          ...
          <div className="token-card-footer dis-between">
            <span className="token-card-footer-left">Pepe</span>
            <span className="token-card-footer-right">~$0.00000000985467</span>
          </div>
        </div>
        <div className="receive token-card">
          <div className="token-card-header dis-between">
            <span className="token-card-header-left">Receive</span>
            <span className="token-card-header-right">Balance:538.0012</span>
          </div>
          <div className="token-card-body dis-between">
