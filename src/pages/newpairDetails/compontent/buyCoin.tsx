...
function BuyCoin({ changStatus }: any) {
  ...
  return (
    <div className={`buyCoin buyCoinBorder`}>
        ...
        options={[
          {
            value: 'com',
            label: (
              <p className={'rightSelectRow'}>
                <span>Community</span> <CaretDownOutlined />
              </p>
            ),
          },
          {
            ...
            label: (
              <p className={'rightSelectRow'}>
                <span>Fast Trade</span> <CaretDownOutlined />
              </p>
            ),
          },
        ]}
      ...
      {[
        { name: 'Price impact', price: '~ 0.468%' },
        { name: 'Max. slippage', price: '0.5%' },
        { name: 'Network cost', price: '$ 17.7' },
        { name: 'DEX', price: 'Uniswap V2' },
